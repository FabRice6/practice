"""
This solution ties 2 out of 2 games, so also not optimal.j
Comes from: https://github.com/m00nlight/hackerrank/blob/master/ai/Machine-Learning/Stock-Predictions/main.py
"""
